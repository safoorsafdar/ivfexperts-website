...
$articleLastUpdated = isset($articleLastUpdated) ? $articleLastUpdated : null;
?>
<div class="mt-10 pt-8 border-t border-slate-200 flex items-start gap-5 bg-slate-50 rounded-2xl p-6" itemscope itemtype="https://schema.org/Person">
    <img src="/assets/images/dr-adnan.jpg"
         ...
         itemprop="image">
    <div>
        <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-0.5"><?php echo htmlspecialchars($authorByline, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></p>
        ...
        <div class="flex items-center gap-4 mt-3">
            ...
            <span class="text-xs text-slate-400">Last updated: <?php echo htmlspecialchars($articleLastUpdated, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?></span>
            <?php endif; ?>
        </div>
    </div>
</div>

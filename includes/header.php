    ...
    <nav style="padding:16px 0;">
      ...
      <div class="mobile-accordion" style="border-bottom:1px solid #f1f5f9;">
        ...
        <div class="mobile-accordion-content" style="display:none;padding:0 24px 12px 24px;background:#f8fafc;">
          ...
          <a href="/male-infertility/klinefelters-syndrome.php" style="display:block;padding:8px 16px;font-size:13px;color:#475569;text-decoration:none;"><i class="fa-solid fa-person-circle-question" style="width:16px;text-align:center;margin-right:6px;color:#94a3b8;"></i> Klinefelter's Syndrome</a>

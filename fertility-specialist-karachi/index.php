<?php
$pageTitle = "IVF &amp; Fertility Specialist in Karachi | Dr. Adnan Jabbar — Teleconsultation";
$metaDescription = "Looking for a fertility specialist in Karachi? Dr. Adnan Jabbar offers IVF, ICSI, IUI, and fertility consultations for Karachi patients via teleconsultation. Book on WhatsApp.";
...
<section class="bg-teal-700 py-20 px-6 text-center text-white">
  <div class="max-w-3xl mx-auto">
    ...
    <h1 class="text-4xl md:text-5xl font-extrabold mb-4 leading-tight">
      Fertility Specialist for Karachi Patients
    </h1>
    <p class="text-xl text-teal-100 mb-8 leading-relaxed">
      Dr. Adnan Jabbar — Pakistan's leading IVF and fertility consultant — offers expert teleconsultations for patients across Karachi. Get personalised fertility advice from the comfort of your home.
    </p>
    <a href="https://wa.me/923111101483?text=Hi%20Dr.%20Adnan%2C%20I%20am%20a%20patient%20from%20Karachi%20and%20would%20like%20a%20teleconsultation."
...
<section class="section-md bg-soft">
  <div class="max-w-5xl mx-auto px-6">
    <h2 class="text-3xl font-extrabold text-slate-900 text-center mb-12">Why Karachi Patients Choose Dr. Adnan</h2>
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="card p-8 text-center">
        ...
        <p class="text-slate-600">IVF Experts serves patients across Pakistan — Karachi, Lahore, Islamabad, and beyond — through our teleconsultation service.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section-md bg-white">
  <div class="max-w-5xl mx-auto px-6">
    <h2 class="text-3xl font-extrabold text-slate-900 text-center mb-4">Services Available for Karachi Patients</h2>
